...
/**
 * Manages SharedPreferences for YouTube shorts blocker version control
 *
 * Stores:
 ...
 */
class YoutubeShortsBlockerPreferences(
    ...
    companion object {
        ...
        // Preference keys
        private const val KEY_CURRENT_VERSION = "youtube_shorts_blocker_version"
        private const val KEY_LAST_CHECK_TIME = "youtube_shorts_blocker_last_check_time"
    }

    /**
     * Get the currently installed shorts blocker version
     *
    ...
    /**
     * Save the newly installed shorts blocker version
     *
     * @param version Version string to save
     */
    fun setCurrentVersion(version: String) {
        Timber.d("YouTubeShortsBlocker: Saving version $version")
    ...
    fun updateLastCheckTime() {
        ...
        Timber.d("YouTubeShortsBlocker: Updating last check time to $currentTime")
        sharedPreferences.edit {
    ...
    fun shouldCheckForUpdate(): Boolean {
        ...
        Timber.d(
            "YouTubeShortsBlocker: Should check for update? $shouldCheck " +
     ...
     */
    fun clear() {
        Timber.w("YouTubeShortsBlocker: Clearing all preferences")
        sharedPreferences.edit {
